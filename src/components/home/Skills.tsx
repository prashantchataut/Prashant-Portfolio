...
export default function Skills() {
    return (
        <section id="skills" className="py-32 bg-ash border-t border-ink/5 relative overflow-hidden">
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
                <div className="mb-20 md:flex md:justify-between md:items-end">
                    <div className="max-w-xl">
                        ...
                        <h2 className="text-4xl sm:text-6xl font-black tracking-tighter text-ink">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    {skillGroups.map((group, i) => (
                        <motion.div
                            ...
                            className="bg-white p-10 rounded-3xl border border-ink/5 shadow-sm hover:shadow-2xl hover:border-accent/30 transition-all duration-500 group"
                        >
                            ...
                            <div className="flex flex-wrap gap-2">
                                {group.skills.map((skill) => (
                                    <span
                                        key={skill}
                                        className="px-3 py-1 bg-ash text-ink text-xs font-medium rounded-full border border-ink/5 group-hover:border-accent/20 group-hover:bg-accent/5 transition-colors"
                                    >
                                        {skill}
                                    </span>
                                ))}
